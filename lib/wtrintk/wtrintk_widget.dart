...
import 'wtrintk_model.dart';
export 'wtrintk_model.dart';
...
class _WtrintkWidgetState extends State<WtrintkWidget> {
  late WtrintkModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WtrintkModel());
