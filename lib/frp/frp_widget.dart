...
import 'frp_model.dart';
export 'frp_model.dart';
...
class _FrpWidgetState extends State<FrpWidget> {
  late FrpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FrpModel());
